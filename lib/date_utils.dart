...
class Utils {
  ...
  static List<DateTime> daysInMonth(DateTime month) {
    ...
    // Avoid creating an extra week
    /*if (daysAfter == 0) {
      daysAfter = 7;
    }*/

    var lastToDisplay = last.add(new Duration(days: daysAfter));
    // Adding an extra day because last range element is exclusive
    return daysInRange(firstToDisplay, lastToDisplay.add(Duration(days: 1))).toList();
  }
